 ...
 * @author radu
 *
 * <p>RPC server factory interface.</p>
 *
 */
public interface FileManagerClientFactory {
    /**
     *
     * <p>Setting url where sever is set on.</p>
     *
     * @param url
     */
    ...
    /**
     * <p>Setting ether to verify connection or not.</p>
     *
    ...
    /**
     * <p>Returning server RPC implementation.</p>
     * @return
