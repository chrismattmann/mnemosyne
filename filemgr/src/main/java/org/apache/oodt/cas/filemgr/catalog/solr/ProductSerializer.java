...
public interface ProductSerializer {
	...
	/**
	 * Turn a SolrJ query response into CAS products. SolrCatalog talks to Solr
	 * 10 through HttpJdkSolrClient, which returns SolrDocuments, not XML.
	 */
	QueryResponse deserialize(org.apache.solr.client.solrj.response.QueryResponse response)
